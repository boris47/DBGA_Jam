...
#pragma warning restore 0414
        ...
        void DrawOnPointerEnterPreset(float width)
        {
            ...
            {
                DUIUtils.DrawPunchPresetNormalView(target, onPointerEnterPunchPresetCategoryNameIndex, onPointerEnterPunchPresetCategory, onPointerEnterPunchPresetNameIndex, onPointerEnterPunchPresetName, onPointerEnterPunchNewPreset, width);
                QUI.Space(SPACE_2);
            ...
            {
                DUIUtils.DrawPunchPresetNewPresetView(target, createNewCategoryName, newPresetCategoryName, onPointerEnterPunchPresetCategoryNameIndex, onPointerEnterPunchPresetCategory, onPointerEnterPunchNewPreset, width);
                QUI.Space(SPACE_2);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerEnterSoundToggleOn, onPointerEnterSoundToggleOn, onPointerEnterSoundIndexToggleOn, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiToggle.onPointerEnterNavigationToggleOn, onPointerEnterEditorNavigationDataToggleOn, showOnPointerEnterNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        void DrawOnPointerEnterSoundToggleOff(float width)
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerEnterSoundToggleOff, onPointerEnterSoundToggleOff, onPointerEnterSoundIndexToggleOff, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiToggle.onPointerEnterNavigationToggleOff, onPointerEnterEditorNavigationDataToggleOff, showOnPointerEnterNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        ...
        void DrawOnPointerExitPreset(float width)
        {
            ...
            {
                DUIUtils.DrawPunchPresetNormalView(target, onPointerExitPunchPresetCategoryNameIndex, onPointerExitPunchPresetCategory, onPointerExitPunchPresetNameIndex, onPointerExitPunchPresetName, onPointerExitPunchNewPreset, width);
                QUI.Space(SPACE_2);
            ...
            {
                DUIUtils.DrawPunchPresetNewPresetView(target, createNewCategoryName, newPresetCategoryName, onPointerExitPunchPresetCategoryNameIndex, onPointerExitPunchPresetCategory, onPointerExitPunchNewPreset, width);
                QUI.Space(SPACE_2);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerExitSoundToggleOn, onPointerExitSoundToggleOn, onPointerExitSoundIndexToggleOn, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiToggle.onPointerExitNavigationToggleOn, onPointerExitEditorNavigationDataToggleOn, showOnPointerExitNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        void DrawOnPointerExitSoundToggleOff(float width)
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerExitSoundToggleOff, onPointerExitSoundToggleOff, onPointerExitSoundIndexToggleOff, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiToggle.onPointerExitNavigationToggleOff, onPointerExitEditorNavigationDataToggleOff, showOnPointerExitNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }

        void DrawOnClick(float width)
        {
            DUIUtils.DrawBarWithEnableDisableButton("OnClick", useOnClick, showOnClick, width, BarHeight);
            DUIUtils.DrawLoadPresetInfoMessage("OnClickLoadPresetAtRuntime", infoMessage, useOnClick.boolValue && loadOnClickPunchPresetAtRuntime.boolValue, onClickPunchPresetCategory.stringValue, onClickPunchPresetName.stringValue, showOnClick, width);
        ...
        void DrawOnClickPreset(float width)
        {
            ...
            {
                DUIUtils.DrawPunchPresetNormalView(target, onClickPunchPresetCategoryNameIndex, onClickPunchPresetCategory, onClickPunchPresetNameIndex, onClickPunchPresetName, onClickPunchNewPreset, width);
                QUI.Space(SPACE_2);
            ...
            {
                DUIUtils.DrawPunchPresetNewPresetView(target, createNewCategoryName, newPresetCategoryName, onClickPunchPresetCategoryNameIndex, onClickPunchPresetCategory, onClickPunchNewPreset, width);
                QUI.Space(SPACE_2);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnClickSoundToggleOn, onClickSoundToggleOn, onClickSoundIndexToggleOn, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiToggle.onClickNavigationToggleOn, onClickEditorNavigationDataToggleOn, showOnClickNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
        void DrawOnClickSoundToggleOff(float width)
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnClickSoundToggleOff, onClickSoundToggleOff, onClickSoundIndexToggleOff, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiToggle.onClickNavigationToggleOff, onClickEditorNavigationDataToggleOff, showOnClickNavigation, UpdateAllNavigationData, false, false, width, MiniBarHeight);
        }
