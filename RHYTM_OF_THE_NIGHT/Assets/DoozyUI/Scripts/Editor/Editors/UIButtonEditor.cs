...
#pragma warning restore 0414
        ...
        protected override void GenerateInfoMessages()
        {
            ...
            infoMessage.Add("OnPointerDownLoadPresetAtRuntime",
                            new InfoMessage()
                            {
                                title = "Runtime Preset: " + onPointerDownPunchPresetCategory.stringValue + " / " + onPointerDownPunchPresetName.stringValue,
                                message = "",
                                type = InfoMessageType.Info,
                                show = new AnimBool(loadOnPointerDownPunchPresetAtRuntime.boolValue, Repaint)
                            });

            infoMessage.Add("OnPointerUpLoadPresetAtRuntime",
                            new InfoMessage()
                            {
                                title = "Runtime Preset: " + onPointerUpPunchPresetCategory.stringValue + " / " + onPointerUpPunchPresetName.stringValue,
                                message = "",
                                type = InfoMessageType.Info,
                                show = new AnimBool(loadOnPointerUpPunchPresetAtRuntime.boolValue, Repaint)
                            });
            ...
            infoMessage.Add("OnDoubleClickLoadPresetAtRuntime",
                            new InfoMessage()
                            {
                                title = "Runtime Preset: " + onDoubleClickPunchPresetCategory.stringValue + " / " + onDoubleClickPunchPresetName.stringValue,
                                message = "",
                                type = InfoMessageType.Info,
                                show = new AnimBool(loadOnDoubleClickPunchPresetAtRuntime.boolValue, Repaint)
                            });

            infoMessage.Add("OnLongClickLoadPresetAtRuntime",
                            new InfoMessage()
                            {
                                title = "Runtime Preset: " + onLongClickPunchPresetCategory.stringValue + " / " + onLongClickPunchPresetName.stringValue,
                                message = "",
                                type = InfoMessageType.Info,
                                show = new AnimBool(loadOnLongClickPunchPresetAtRuntime.boolValue, Repaint)
                            });
        ...
        void DrawOnPointerEnter(float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage("OnPointerEnterLoadPresetAtRuntime", infoMessage, useOnPointerEnter.boolValue && loadOnPointerEnterPunchPresetAtRuntime.boolValue, onPointerEnterPunchPresetCategory.stringValue, onPointerEnterPunchPresetName.stringValue, showOnPointerEnter, width);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerEnterSound, onPointerEnterSound, onPointerEnterSoundIndex, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiButton.onPointerEnterNavigation, onPointerEnterEditorNavigationData, showOnPointerEnterNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        void DrawOnPointerExit(float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage("OnPointerExitLoadPresetAtRuntime", infoMessage, useOnPointerExit.boolValue && loadOnPointerExitPunchPresetAtRuntime.boolValue, onPointerExitPunchPresetCategory.stringValue, onPointerExitPunchPresetName.stringValue, showOnPointerExit, width);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerExitSound, onPointerExitSound, onPointerExitSoundIndex, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiButton.onPointerExitNavigation, onPointerExitEditorNavigationData, showOnPointerExitNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        void DrawOnPointerDown(float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage("OnPointerDownLoadPresetAtRuntime", infoMessage, useOnPointerDown.boolValue && loadOnPointerDownPunchPresetAtRuntime.boolValue, onPointerDownPunchPresetCategory.stringValue, onPointerDownPunchPresetName.stringValue, showOnPointerDown, width);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerDownSound, onPointerDownSound, onPointerDownSoundIndex, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiButton.onPointerDownNavigation, onPointerDownEditorNavigationData, showOnPointerDownNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        void DrawOnPointerUp(float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage("OnPointerUpLoadPresetAtRuntime", infoMessage, useOnPointerUp.boolValue && loadOnPointerUpPunchPresetAtRuntime.boolValue, onPointerUpPunchPresetCategory.stringValue, onPointerUpPunchPresetName.stringValue, showOnPointerUp, width);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnPointerUpSound, onPointerUpSound, onPointerUpSoundIndex, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiButton.onPointerUpNavigation, onPointerUpEditorNavigationData, showOnPointerUpNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        void DrawOnClick(float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage("OnClickLoadPresetAtRuntime", infoMessage, useOnClickAnimations.boolValue && loadOnClickPunchPresetAtRuntime.boolValue, onClickPunchPresetCategory.stringValue, onClickPunchPresetName.stringValue, showOnClick, width);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnClickSound, onClickSound, onClickSoundIndex, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiButton.onClickNavigation, onClickEditorNavigationData, showOnClickNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        void DrawOnDoubleClick(float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage("OnDoubleClickLoadPresetAtRuntime", infoMessage, useOnDoubleClick.boolValue && loadOnDoubleClickPunchPresetAtRuntime.boolValue, onDoubleClickPunchPresetCategory.stringValue, onDoubleClickPunchPresetName.stringValue, showOnDoubleClick, width);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnDoubleClickSound, onDoubleClickSound, onDoubleClickSoundIndex, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiButton.onDoubleClickNavigation, onDoubleClickEditorNavigationData, showOnDoubleClickNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        void DrawOnLongClick(float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage("OnLongClickLoadPresetAtRuntime", infoMessage, useOnLongClick.boolValue && loadOnLongClickPunchPresetAtRuntime.boolValue, onLongClickPunchPresetCategory.stringValue, onLongClickPunchPresetName.stringValue, showOnLongClick, width);
        ...
        {
            DUIUtils.DrawSound(target, "Play Sound", customOnLongClickSound, onLongClickSound, onLongClickSoundIndex, width);
        }
        ...
        {
            DUIUtils.DrawNavigation(target, uiButton.onLongClickNavigation, onLongClickEditorNavigationData, showOnLongClickNavigation, UpdateAllNavigationData, true, uiButton.IsBackButton, width, MiniBarHeight);
        }
        ...
        void DrawLoopAnimations(ButtonLoopType loopType, bool enabled, SerializedProperty loadPresetAtRuntime, AnimBool showAnimation, Index presetCategoryIndex, SerializedProperty presetCategory, Index presetNameIndex, SerializedProperty presetName, AnimBool newPreset, float width)
        {
            ...
            DUIUtils.DrawLoadPresetInfoMessage(loopType + "LoopLoadPresetAtRuntime", infoMessage, loadPresetAtRuntime.boolValue, presetCategory.stringValue, presetName.stringValue, showAnimation, width);
                        ...
                        float width)
        {
            ...
            switch((UIButton.ButtonAnimationType)animationType.enumValueIndex)
            {
                case UIButton.ButtonAnimationType.Punch:
                    ...
                    {
                        DUIUtils.DrawPunchPresetNormalView(target, punchPresetCategoryNameIndex, punchPresetCategory, punchPresetNameIndex, punchPresetName, punchNewPreset, width);
                        QUI.Space(SPACE_2);
                    ...
                    {
                        DUIUtils.DrawPunchPresetNewPresetView(target, createNewCategoryName, newPresetCategoryName, punchPresetCategoryNameIndex, punchPresetCategory, punchNewPreset, width);
                        QUI.Space(SPACE_2);
                ...
                case UIButton.ButtonAnimationType.State:
                    ...
                    {
                        DUIUtils.DrawStatePresetNormalView(target, statePresetCategoryNameIndex, statePresetCategory, statePresetNameIndex, statePresetName, stateNewPreset, width);
                        QUI.Space(SPACE_2);
                    ...
                    {
                        DUIUtils.DrawStatePresetNewPresetView(target, createNewCategoryName, newPresetCategoryName, statePresetCategoryNameIndex, statePresetCategory, stateNewPreset, width);
                        QUI.Space(SPACE_2);
