...
namespace DoozyUI
{
    public class DUIUtils
    {
        ...
        public static void DrawPunchPresetNormalView(Object target, Index presetCategoryIndex, SerializedProperty presetCategoryName, Index presetNameIndex, SerializedProperty presetName, AnimBool newPreset, float width)
        {
        ...
        public static void DrawPunchPresetNewPresetView(Object target, AnimBool createNewCategoryName, Name newPresetCategoryName, Index presetCategoryIndex, SerializedProperty presetCategory, AnimBool newPreset, float width)
        {
            tempFloat = (width - 6) / 2 - 5; //dropdown lists width
            QUI.BeginHorizontal(width);
            {
                ...
                newPresetCategoryName.name = EditorGUILayout.TextField(newPresetCategoryName.name, GUILayout.Width(tempFloat * newPreset.faded));
        ...
        public static void DrawStatePresetNormalView(Object target, Index presetCategoryIndex, SerializedProperty presetCategoryName, Index presetNameIndex, SerializedProperty presetName, AnimBool newPreset, float width)
        {
            tempFloat = (width - 6) / 2 - 5; //dropdown lists width
            QUI.BeginHorizontal(width);
            {
        ...
        public static void DrawStatePresetNewPresetView(Object target, AnimBool createNewCategoryName, Name newPresetCategoryName, Index presetCategoryIndex, SerializedProperty presetCategory, AnimBool newPreset, float width)
        {
            tempFloat = (width - 6) / 2 - 5; //dropdown lists width
            QUI.BeginHorizontal(width);
            {
                if(createNewCategoryName.faded < 0.5f)
                {
                    ...
                    {
                        Undo.RecordObject(target, "ChangeCategory");
                        presetCategory.stringValue = DUIData.Instance.DatabaseStateAnimations.categoryNames[presetCategoryIndex.index]; //set category naame
                    }
        ...
        public static void DrawSound(Object target, string label, SerializedProperty customSound, SerializedProperty sound, Index index, float width)
        {
            QUI.BeginVertical(width);
            {
                ...
                QUI.BeginHorizontal(width);
                {
                    ...
                    else
                    {
                        ...
                        if(QUI.EndChangeCheck())
                        {
                            Undo.RecordObject(target, "UpdatedSoundName");
        ...
        public static void DrawLoadPresetInfoMessage(string loadPresetInfoMessageTag, Dictionary<string, InfoMessage> infoMessage, bool loadPresetAtRuntime, string categoryName, string presetName, AnimBool show, float width)
        {
        ...
        public static void DrawNavigation(Object target, NavigationPointerData navigationPointerData, EditorNavigationPointerData editorNavigationPointerData, AnimBool show, UnityAction UpdateAllNavigationData, bool useNavigationHistory, bool isBackButton, float width, float miniBarHeight)
        {
            ...
            QUI.BeginHorizontal(width);
            {
                ...
                if(QUI.BeginFadeGroup(show.faded))
                {
                    ...
                    {
                        QUI.Space(2);
                        DrawNavigationData(target, navigationPointerData, editorNavigationPointerData, UpdateAllNavigationData, useNavigationHistory, isBackButton, width - 8);
                        QUI.Space(8);
                    }
                    QUI.EndVertical();
                }
        ...
        private static void DrawNavigationData(Object target, NavigationPointerData navData, EditorNavigationPointerData editorNavData, UnityAction UpdateAllNavigationData, bool useNavigationHistory, bool isBackButton, float width)
        {
            if(useNavigationHistory)
            {
                QUI.BeginHorizontal(width);
                {
                    ...
                    if(QUI.EndChangeCheck())
                    {
                        Undo.RecordObject(target, "ToggleNavHistory");
            ...
            DrawNavigationDataList(target, NavigationType.Show, navData.show, editorNavData.showIndex, UpdateAllNavigationData, useNavigationHistory, isBackButton, width);
            QUI.Space(4);
            DrawNavigationDataList(target, NavigationType.Hide, navData.hide, editorNavData.hideIndex, UpdateAllNavigationData, useNavigationHistory, isBackButton, width);
        }
        private static void DrawNavigationDataList(Object target, NavigationType navigationType, List<NavigationPointer> list, List<EditorNavigationPointer> listIndex, UnityAction UpdateAllNavigationData, bool useNavigationHistory, bool isBackButton, float width)
        {
                    ...
                    else //this is NOT a Back button
                    {
                        ...
                        for(int i = 0; i < list.Count; i++)
                        {
                            QUI.BeginHorizontal(width);
                            {
                                ...
                                if(QUI.EndChangeCheck())
                                {
                                    Undo.RecordObject(target, "UpdateNavigation");
                                ...
                                QUI.BeginVertical(16, 16);
                                {
                                    if(QUI.ButtonMinus())
                                    {
                                        Undo.RecordObject(target, "Removed NavigationPointer");
                                        list.RemoveAt(i);
                        ...
                        QUI.BeginHorizontal(width);
                        {
                            ...
                            QUI.BeginVertical(16, 16);
                            {
                                if(QUI.ButtonPlus())
                                {
                                    Undo.RecordObject(target, "Added NavigationPointer");
